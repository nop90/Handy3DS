    ...
    switch (Handy_rotation) {
		case 0:
			switch (Handy_cfg_scalemode) {
				case 0:
					sf2d_draw_texture_rotate_cut_scale(currentscreen, 120, 69, 0, 0, 0, 160, 102, 1, 1); //1x
					break;
				case 1:
					sf2d_draw_texture_rotate_cut_scale(currentscreen, 40, 18, 0, 0, 0, 160, 102, 2, 2); //2x
					break;
				case 2:
					sf2d_draw_texture_rotate_cut_scale(currentscreen, 12, 0, 0, 0, 0, 160, 102, stretchy, stretchy);    //fit
					break;
				case 3:
				default:
					sf2d_draw_texture_rotate_cut_scale(currentscreen, 0, 0, 0, 0, 0, 160, 102, stretchx, stretchy);  //stretch
					break;
			}
			break;
		case 1:
			switch (Handy_cfg_scalemode) {
				case 0:
					sf2d_draw_texture_rotate_cut_scale(currentscreen, 120, 69, 1.57, 0, 0, 160, 102, 1, 1); //1x
					break;
				case 1:
				case 2:
				case 3:
				default:
					sf2d_draw_texture_rotate_cut_scale(currentscreen, 80,44, 1.57, 0, 0, 160, 102, stretchr, stretchr);    //fit
					break;
			}
			break;
		case 2:
			switch (Handy_cfg_scalemode) {
				case 0:
					sf2d_draw_texture_rotate_cut_scale(currentscreen, 120, 69, 3.14, 0, 0, 160, 102, 1, 1); //1x
					break;
				case 1:
					sf2d_draw_texture_rotate_cut_scale(currentscreen, 40, 18, 3.14, 0, 0, 160, 102, 2, 2); //2x
					break;
				case 2:
					sf2d_draw_texture_rotate_cut_scale(currentscreen, 12, 1, 3.14, 0, 0, 160, 102, stretchy, stretchy);    //fit
					break;
				case 3:
				default:
					sf2d_draw_texture_rotate_cut_scale(currentscreen, 0, 0, 3.14, 0, 0, 160, 102, stretchx, stretchy);  //stretch
					break;
			}
			break;
		case 3:
		default:
			switch (Handy_cfg_scalemode) {
				case 0:
					sf2d_draw_texture_rotate_cut_scale(currentscreen, 120, 69, 4.71, 0, 0, 160, 102, 1, 1); //1x
					break;
				case 1:
				case 2:
				case 3:
				default:
					sf2d_draw_texture_rotate_cut_scale(currentscreen, 80, 44, 4.71, 0, 0, 160, 102, stretchr, stretchr);    //fit
					break;
			}
			break;
	}
