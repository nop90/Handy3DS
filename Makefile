...
APP_TITLE		:= Handy 3ds
APP_DESCRIPTION	:= Handy 3ds - ATARI Lynx emulator
APP_AUTHOR		:= NOP90/hippy dave/SDLEmu/K Wilkins
...
CFLAGS	:=	-g -Wall -O2 -mword-relocations \
			...
			$(ARCH) -DDINGUX -DSDL_PATCH -DANSI_GCC
...
LIBS	:= -lsftd -lfreetype -lpng -lz -lsf2d -lctru -lsfil -lm
